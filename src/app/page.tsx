    ...
    <section className="py-12 bg-background">
      <div className="container mx-auto">
        <h2 className="text-3xl font-semibold text-center mb-8 text-foreground">
          Dead Rails Script Directory (2025) – The Most Complete Dead Rails Script Collection (High Keyword Density: Dead Rails Script)
        </h2>
        <p className="text-lg text-center mb-6 text-muted-foreground">
          This page is dedicated to Dead Rails Script enthusiasts. Here you will find the most comprehensive Dead Rails Script collection for 2025, with Dead Rails Script options for every user. Whether you are a beginner or an advanced gamer, this Dead Rails Script directory will help you discover, copy, and use a variety of Dead Rails Script files. Dead Rails Script scripts are designed to enhance your Dead Rails Script experience, making Dead Rails Script easier and more efficient. Explore this Dead Rails Script directory to find the best Dead Rails Script for your needs. Dead Rails Script is your best choice for Dead Rails Script automation and Dead Rails Script customization.
        </p>
